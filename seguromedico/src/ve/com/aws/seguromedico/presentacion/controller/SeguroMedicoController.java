package ve.com.aws.seguromedico.presentacion.controller;
...
import ve.com.aws.seguromedico.persistencia.implementacion.SeguroMedicoDAOImpl;
...
public class SeguroMedicoController {
	...
	@Autowired
	ISeguroMedicoDAO seguroMedicoDAO;
	 ...
	 @RequestMapping(value = "/SeguroMedico/{idSeguroMedico}", method = RequestMethod.GET, produces = "application/json")
	    public void read(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @PathVariable("idSeguroMedico") int idSeguroMedico) {
		 seguroMedicoDAO = new SeguroMedicoDAOImpl().getSeguroMedicoDAOImpl();   
		 try {
	        ...
	        } catch (SeguroMedicoException ex) {
	            List<SeguroMedicoMensaje> SeguroMedicoMensaje=ex.getSeguroMedicoMensajes();
	            String jsonSalida = jsonTransformer.toJson(SeguroMedicoMensaje);
